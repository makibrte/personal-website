...
export default function Page(){
    ...
    return (
        <main className="antialiased flex min-h-screen flex-col items-center justify-center bg-slate-100 px-4 sm:px-[18rem] w-full">
            <h1 className={'text-stone-900'}>hello there! if you are not me here is the way back to <a className={'text-red-700'} href={'/'}>safety!</a></h1>
            {alert && <Alert msg={alert.msg} type={alert.type}/>}
            <div className="shadow-lg rounded-md p-6 border bg-white">
                <h1 className="font-semibold mb-2 text-stone-900">Login</h1>
